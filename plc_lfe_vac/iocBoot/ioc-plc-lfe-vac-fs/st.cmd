...
epicsEnvSet("LOCATION", "PLC:LFE:VAC:FS" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:LFE:VAC:FS")
dbLoadRecords("save_restoreStatus.db", "P=PLC:LFE:VAC:FS:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:LFE:VAC:FS")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:LFE:VAC:FS")
...
save_restoreSet_status_prefix( "PLC:LFE:VAC:FS:" )
